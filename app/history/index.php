...
<head>
    ...
    <title>History<?php echo $main_title; ?></title>
    <style>
    #load-more{
        font-size:1.2em;
        cursor:pointer;
...
<body>
    ...
    <div id="content">
        ...
        <div class=" d-flex justify-content-center hide" style="height:40vh;opacity:.6;" id="not-found">
            ...
            <p style="max-width:80%;margin:10px auto;display:table;" class="text-center">It seems that you haven't done any transaction yet.</p>
            </div>
        </div>
...
<script>
    $(document).ready(function(){
        $("#history").addClass("active").attr('onclick','');
        getData();
    });
    var start = 0;
    var limit = 10;
    ...
    */
    function getData(){
        ...
        $.ajax({
            url: '<?php echo $api_directory; ?>web/users/get_history.php',
            method: 'POST',
            dataType: 'text',
            data: {
