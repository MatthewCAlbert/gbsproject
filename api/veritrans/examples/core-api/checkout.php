...
Veritrans_Config::$clientKey = "$veritrans_server_key";

if ( strpos(Veritrans_Config::$clientKey,$veritrans_server_key) != false ) {
...
<body>
  ...
  <script type="text/javascript">
    $(function () {
      ...
      Veritrans.client_key = "<?php echo Veritrans_Config::$veritrans_client_key ?>";
      var card = function () {
        return {
