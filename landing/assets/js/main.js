...
function toggleNav(){
    if( $("#menu-button").hasClass('is-active') ){
        ...
        $("aside.sidenav").addClass('active');
        $("body").css({"overflow":"hidden"});
        $('header').append('<div class="black-overlay" onclick="toggleNav()"></div>');
    }
}
function toggleHelp(){
    if( $("#help-area").hasClass('active') ){
        $("#help-area").removeClass('active');
    }else{
        $("#help-area").addClass('active');
    }
}
