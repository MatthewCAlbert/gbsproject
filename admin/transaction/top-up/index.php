...
<head>
    ...
    ?>
    <title>Top Up - GBS eMoney Admin</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-chart card-header-info">
                                <h4 class="card-title">Top Up Form</h4>
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                        if(isset($_POST['submit'])){
                                            ...
                                            if( $value < 1000 ){
                                                header('Location: ../top-up?warning=minimum-value-Rp-1.000');
                                                exit();
                                            }
                                            ...
                                            if($status != false){
                                                if( $row['status'] == 'banned' ){
                                                    header('Location: ../top-up?warning=target-user-is-banned');
                                                    exit();
                                                }
                                                ...
                                                if( $res ){
                                                    echo '<p class="alert alert-success">Top Up Success! (Rp '.number_format($value).') ( '.$row['name'].' )</p>';
                                                    $desc = 'Top Up Success!';
                                                    $request_res = 'success';
                                                    if( !$res11 ){
                                                ...
                                                ('Top Up','$id','$where','$value','$desc','$request_res','$admin_username') ";
                                                $res = $conn->query($sql);
                                                if( $res ){
