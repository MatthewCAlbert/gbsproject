...
<head>
    ...
    <title>Demo Import CSV - GBS eMoney Maintenance</title>
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header card-chart card-header-info">
                                <h4 class="card-title">Import CSV for DEMO Purpose Only</h4>
                                <p class="card-category">Maintenance</p>
                            </div>
                            <div class="card-body">
                                <div class="container">
                                <form method="post" action="import.php" enctype="multipart/form-data">
                                    <label>Table Target : </label><br>
                                    <select name="target" class="form-control">
                                        <option value="1">Transaction Log</option>
                                        <option value="2">Balance History</option>
                                    </select><br><br>
                                    <label>Output Name File</label> 
                                    <input type="text" name="filename" value="output" class="form-control" required><br><br>
