...
<head>
    ...
    require 'search.php';
    ?>
    <title>Session Search - GBS eMoney Admin</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-chart card-header-success">
                                <h4 class="card-title">Transaction Receipt</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <select name="by" id="filter2" class="form-control" onclick="switchFilterOption()">
                                            ...
                                            <option value="receiver">Receiver ID</option>
                                        ...
                                        if( $res->num_rows > 0 ){
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-right">Machine ID</th>
                                                </tr>
                                            </thead>
                                            <tbody>';
